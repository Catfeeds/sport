...
<body>
<s:url var="searchUrl" value="simpleSearch?condition.searchType=coach" includeParams="none">
    ...
    <div class="sport_body_left">
		<div class="banner">
            ...
            <s:iterator value="discounts"> 
                <li><a href="discountanddiscountDetail?discount.id=<s:property value='id'/>"><img src=".<s:property value='preViewImg.pathName'/>"></a></li>
            </s:iterator>    
            </ul>
       	...
       	<s:iterator value="coachs">
       		<div class="left_result_info">
	            ...
	            <div class="left_result_info_bief">
	            	<strong><s:property value='realName'/></strong><br /><br />
	                <p>居住地：<s:property value='homeAddress.addressName'/>><s:property value='addressName'/></p>
	            </div>
	            <div class="left_result_info_cost">
	                <p>原价: <span><s:property value='basePrice'/></span>&nbsp;元</p>
	                <br />
	              	<a href="orderCoach?coach.id=<s:property value='id'/>" class="abutton"> 预约教练 </a>
	           </div>
       	 </div>
       	</s:iterator>
    ...
    <div class="clearfix"></div>
        ...
        <div class="right_hot_sport">
       		<div class="right_hot_title">
       		  <p>热门教练</p></div>
       		  <!-- 只展示前五个置顶的教练 -->
       		  <s:iterator value="coachs" status="st">
       		  	<s:if test="#st.index<5">
				<div class="right_hot_list_div">
                  <div class="hot_list_img">
	                  <a href="orderCoach?coach.id=<s:property value='id'/>">
	                  	<img src=".<s:property value='photoes[0].pathName'/>"/>
	                  </a>
                  </div>
                  ...
                  </strong><p>价格：&yen;<s:property value='basePrice'/></p></div>
                </div> 
                </s:if>           
             </s:iterator>   	 
       </div>
