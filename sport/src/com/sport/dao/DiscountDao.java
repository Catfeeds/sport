...
public class DiscountDao extends RootDao{
	...
	public  int findAll(List<Discount> discounts,Discount discount,
		...
		StringBuffer queryString=
				new StringBuffer("from Discount e where 1=1 and e.discountStatus="+discount.getDiscountStatus());
	...
	public void findAll(List<Discount> discounts, Discount discount, int pageNumber,
			int pageSize) {
