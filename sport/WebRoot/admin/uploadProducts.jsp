		...
		<div class="unloadProductWrap">
			<div class="uploadFormWrap">
						...
						<div class="item" id="parentTypeId" id="productTypeParentWrap">
							<div class="selectContent" id="parentTypeWrap">
								<select id='productTypeParent' >
									<s:iterator value="rootTypes[0].childrenProductTypes">
										<option value="<s:property value='id'/>">
											<s:property value="typeName"/>
										</option>
									</s:iterator>
						...
						<div class="item lastitem" id="childTypeId">
							<div class="selectContent" id="productTypeWrap">
								<select id='productType'>
									<s:iterator value="rootTypes[0].childrenProductTypes[0].childrenProductTypes">
										<option value="<s:property value='id'/>">
											<s:property value="typeName"/>
										</option>
									</s:iterator>
				...
				<div class="uploadItem">
					...
					<div calss="itemContent">
						<select id="productLevel" name="product.level">
							<option checked value="一等品">一等品</option>
				...
				<div class="uploadItem">
					...
					<div calss="itemContent">
						<input type="text" name="product.memberPrice" class="inputText textLength1"></input>
					</div>
				</div>
				<div class="uploadItem">
					<div class="itemIitle">
					...
					<div calss="itemContent">
						<input type="text" name="product.sendCost" class="inputText textLength1"></input>
					</div>
				</div>
				<div class="uploadItem">
					<div class="itemIitle">
					生产日期：</div>
					<div calss="itemContent">
					<input type="text" name="product.productDate" id="productDate" class="inputText textLength1"></input>
					</div>
				</div>
				<div class="uploadItem">
					<div class="itemIitle">
					...
					<div calss="itemContent">
						<input type="text" name="product.saveDays" class="inputText textLength1"></input>(天)
					</div>
				</div>
				...
				<div class="uploadItem">
					...
					尺寸：</div>
					<div calss="itemContent">
						<input type="text" name="product.size" class="inputText textLength1"></input>
					</div>
				</div>
				<div class="uploadItem">
					<div class="itemIitle">
					颜色：</div>
					<div calss="itemContent">
						<input type="text" name="product.color" class="inputText textLength1"></input>
					</div>
				</div>
