...
<link href="res/commonComponents/weixinscanpage/css/scanPay.css"
	rel="stylesheet" type="text/css" />
<script src='res/js/jquery-1.8.3.min.js' type="text/javascript"></script>
<script src="res/js/qrcode.js"></script>
<!-- 弹出登录注册对话框 -->
<link rel="stylesheet"
	href="res/commonComponents/loginPopDialog/css/loginbox.css"
	type="text/css" />
...
<body>
	<!--固定头部-->
	<iframe src="header" frameborder="0" scrolling="no" width="100%"
		height="190px"></iframe>
	<input type="hidden" name="codeUrl"
		value="<s:property value='nativePayUrl'/>" />
	...
	<input type="hidden" name="successRedirectUrl"
		value="orderandpayedOrder?order.id=<s:property value='order.id'/>" />
	<input type="hidden" name="failRedirectUrl"
		value="orderandtoPayOrder?order.id=<s:property value='order.id'/>" />
	<!--固定尾部-->
	<div>
		<iframe src="footer.jsp" frameborder="0" scrolling="no" width="100%"
			height="175px"></iframe>
	</div>
	<script type="text/javascript">
		...
		$("#qrcodeImgWrap img").css("width", "250px").css("height", "250px")
				.css("border", "1px  #FF7800 solid");
		...
		function queryOrderStatus() {
			$.post("orderandqueryOrderStatus", {"order.id" : orderId}, function(data) {
				var arr = new Array();
