...
<body>
<form action="coachandalterCoach" method="post">
	<div class="tabmain">
		
			<input type="hidden" name="coach.id" value="<s:property value='coach.id'/>"/>
			<div id="outerWrap">
					...
					<div id="content">
						<div class="tabContent  selectedContent">
							...
							<div class="innerContent">
								<dl>
									...
									<dd>
										<input type="text" name="coach.realName"
											class="inputText textLength1" value="<s:property value='coach.realName'/>"></input> <span
											class="colorange">提示信息！</span>
									</dd>
								</dl>
								<dl>
									<dt>
									...
									<dd>
										<s:if test="coach.sex.equals(\"男\")">
											<input type="radio" name="coach.sex" checked="checked"	value="男" />&nbsp;男 
											&nbsp;&nbsp;<input type="radio"	name="coach.sex" value="女" />&nbsp;女
										</s:if>
										<s:else>
											<input type="radio" name="coach.sex"	value="男" />&nbsp;男 
											&nbsp;&nbsp;<input type="radio"	name="coach.sex" checked="checked" value="女" />&nbsp;女
										</s:else>
									</dd>
								</dl>
								<dl>
									...
									<dd>
										<input type="text" id="coachBirthday" name="coach.birthday"
											class="inputText textLength1" value="<s:property value='coach.birthday'/>"></input>
									</dd>
								</dl>
								...
								<dl>
									...
									<dd>
										<span><s:property value='coach.userName'/></span>
									</dd>
								</dl>
								<dl>
									<dt>
									...
									<dd>
										<input type="password" name="coach.password"
											value="<s:property value='coach.password'/>" class="inputText textLength1"></input>
									</dd>
								</dl>
							</div>
						</div>
						<div class="tabContent">
							...
							<div class="innerContent">
								<dl>
									...
									<dd>
										<input type="text" name="coach.phone"
											class="inputText textLength1" value="<s:property value='coach.phone'/>"></input> <span
											class="colorange">提示信息！</span>
									</dd>
								</dl>
								<dl>
									...
									<dd>
										<input type="text" name="coach.telephone" value="<s:property value='coach.telephone'/>"
								...
								<dl>
									...
									<dd>
										<input type="text" name="coach.email" value="<s:property value='coach.email'/>"
											class="inputText textLength1"></input>
									</dd>
								</dl>
								<dl>
									...
									<dd>
										<input type="text" name="coach.postcode" value="<s:property value='coach.postcode'/>"
											class="inputText textLength1"></input>
									</dd>
								</dl>
								<dl>
									...
									<select id="province1" >
						            	<s:iterator value="rootAddrs">
						            		<s:if test="id==coach.homeAddress.parentAddress.parentAddress.id">
						            ...
						            <select id="city1" >
						               <s:iterator value="coach.homeAddress.parentAddress.parentAddress.childrenAddress">
						            		<s:if test="id==coach.homeAddress.parentAddress.id">
						                		<option selected="selected" value="<s:property value='id'/>"><s:property value='addressName'/></option>
						                	</s:if>
						                	<s:else>
						                		<option value="<s:property value='id'/>"><s:property value='addressName'/></option>
						            ...
						            <select id="region1" name="coach.homeAddress.id">
						                <s:iterator value="coach.homeAddress.parentAddress.childrenAddress">
						                	<s:if test="id==coach.homeAddress.id">
						                		<option selected="selected" value="<s:property value='id'/>"><s:property value='addressName'/></option>
						                	</s:if>
						                	<s:else>
						                		<option value="<s:property value='id'/>"><s:property value='addressName'/></option>
								...
								<dl>
									...
									<dd>
										<input type="text" name="coach.addressName" value="<s:property value='coach.addressName'/>"
							...
							<div class="innerContent">
								...
								<div class="contentBody" style="margin-left:-100px;">
									...
									<div class="selectWeek">
										 <ul class="week">
								            	<s:iterator value="coach.weekJobTimes"  var="time" status="st"><!-- 下一个 -->
													<s:if test="#time==1" >
								             ...
								             <input type="hidden" id="weekstring"   name="coach.weekJobTime" 
								            value="<s:property value='coach.weekJobTime'/>"/>
									...
									<div class="selectTime">									
										<div class="coach-time-optional">
											<ul>
													<s:if test="coach.dayJobTimeArr[0]==1">
														<li >													
														<span  class="chooseItem coach-time-selected">上午 09：00--12：00</span>
														&emsp;&emsp;默认价格:
														<input type="text" name="coach.baseCostPrices" class="optional-input" 
																value="<s:property value='coach.baseCostPrices[0]'/>"/>
														<input type="hidden" id="times0" name="coach.dayJobTimeArr" value="1"/>&yen;</li>
													</s:if>
													<s:else>
														<li>
													...
													<s:if test="coach.dayJobTimeArr[1]==1">
														<li><span class="chooseItem coach-time-selected">下午 14：00--17：00</span>
														&emsp;&emsp;默认价格:<input type="text" name="coach.baseCostPrices"
																 value="<s:property value='coach.baseCostPrices[1]'/>" class="optional-input" />
														<input type="hidden" id="times1" name="coach.dayJobTimeArr" value="1"/>&yen;</li>
													</s:if>
													<s:else>
													...
													<s:if test="coach.dayJobTimeArr[2]==1">
														<li ><span  class="chooseItem coach-time-selected">晚上 19：00--21：00</span>
														&emsp;&emsp;默认价格:<input type="text" name="coach.baseCostPrices"
														  value="<s:property value='coach.baseCostPrices[2]'/>" class="optional-input" />
														<input type="hidden" id="times2" name="coach.dayJobTimeArr" value="1"/>&yen;</li>
													</s:if>
													<s:else>
													...
													&emsp;&emsp;全天价格:<input type="text" name="coach.baseCostPrices" 
													 value="<s:property value='coach.baseCostPrices[3]'/>"  style="width:50px;border: 1px solid rgb(66,66,66);margin:5px;"  />
													<input type="hidden" id="times2" name="coach.dayJobTimeArr" value="<s:property value='coach.dayJobTimeArr[3]'/>"/>&yen;
						...
						<div class="tabContent">
							...
							<div class="innerContent">
								...
								<div class="contentBody" style="margin-left:-100px;">																	
									<div style="clear:both;"></div>
									<div style="font-size:18px;font-family:'微软雅黑';">活动地点选择(最多<span id="totalRegionNumber">4</span>个)</div>
									<div class="extraService">
										<div class="selectedAddressWrap">
											<div class="addressItem">
												您已选择以下
												<span id="regionNumber">
													<s:property  value='coach.addrs.size()' />
												</span>
												个活动区域，最多还可选<span id="spareNumber" ><s:property  value='4-coach.addrs.size()' /></span>个
											</div>
											<s:iterator value='coach.addrs' status="status">
												<div class='addressItem' id='addrItemId<s:property value='#status.index'/>'>
													<span class='selectedaddress'>
														<s:property value='parentAddress.parentAddress.addressName'/>->
														<s:property value='parentAddress.addressName'/>->
														<s:property value='addressName'/>
													</span>
													<span class='removeBtn'>
														<a class='blue button' addrItemId="<s:property value='#status.index'/>" addrId="<s:property value='id'/>" href='javascript:void(0);'>移除</a>
													</span>
													<input type='hidden' name='coach.addrIds' value='<s:property value='id'/>'/>
												</div>
											</s:iterator>
						...
						<div class="tabContent">
							...
							<div class="innerContent">
								...
								<div class="contentBody" style="margin-left:-100px;">	
									...
									<div style="clear:both;"></div>
									<div style="font-size:18px;font-family:'微软雅黑';">起步价:</div>
									<div class="extraService" style="margin-top:10px;">
										<input type="text" name="coach.basePrice" value="<s:property value='coach.basePrice'/>"
														class="inputText textLength1"></input>	(单位：&yen;)									
									</div>
																								
									<div style="clear:both;"></div>
									<div style="font-size:18px;font-family:'微软雅黑';">每次同时为用户提供服务的用户数上限:</div>
									<div class="extraService" style="margin-top:10px;">
										<input type="text" name="coach.employNumber" value="<s:property value='coach.employNumber'/>"
														class="inputText textLength1"></input>	(单位：个)									
									</div>
									
									<div style="clear:both;"></div>
									<div style="font-size:18px;font-family:'微软雅黑';">可以修改您的擅长项目(只能一种)</div>
									<div class="extraService">
										<select name="coach.skillType.id"  id="TypeSelect">
											<s:iterator value='types'>
												<s:if test="coach.skillType.id==id">
													<option selected="selected" value='<s:property value='id'/>'><s:property value="typeName"/></option>
												</s:if>
												<s:else>
									...
									<div style="clear:both;"></div>
									<div style="font-size:18px;font-family:'微软雅黑';margin-top:30px;">选择您可以提供的产品(多选)</div>
									<div class="extraService">
										<ul class="week" id="productsList">
											<s:iterator value="coach.coachCosts" status="st">
												<li><input  class="weekItem productItem" checked="checked"
													 type="checkbox" id="productItem<s:property value='product.id'/>"
													 productId="<s:property  value='product.id'/>"
													value="<s:property value='product.id'/>" name="coach.coachProductIds">&emsp;
													<input type='hidden' name="coach.costs"
														value='<s:property value="timePrice"/>'
													 	id='costs<s:property value="product.id"/>'/>
													<label class='tbut' productId="<s:property value='product.id'/>">
						...
						<div class="tabContent">
							...
							<div class="innerContent">
								...
								<div class="contentBody" style="margin-left:-100px;">																	
									<div style="clear:both;"></div>
									<div style="font-size:18px;font-family:'微软雅黑';">个人生活照(3张即可)</div>
						...
						<div class="tabContent">
							...
							<dl>
								...
								<dd>
									<textarea id="coachDetail" name="coach.detail"><s:property escapeHtml="false" value='coach.detail'/></textarea>
								</dd>
							</dl>
...
<script type="text/javascript">
	$(function(){
		...
		for(var i=0;i<7;i++){
			str=weekstr[i];
			$(".week li").eq(i).append(str);
			ids='w'+(i+1);//alert(ids);
			$(".week li>input").eq(i).attr('id',ids);
		}
