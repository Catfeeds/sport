...
<body>
<s:url var="searchUrl" value="weixin/articleandarticleDetail" includeParams="none">
		...
		<div class="discountListBox">
			<ul class="discountList">
				<li>
        			...
        			<div style="clear:both;"></div>
        			<div class="ch-con">
        				标题：<s:property value='rootArticle.title'/><br/>
        				内容：<s:property value='rootArticle.content'/>
        			</div>
					<div class="po-box">
						<div class="po-zan" >
							<a href="javascript:void(0);" class="supportBtn" 
								articleId="<s:property value='rootArticle.id'/>"
								>
								<img src="weixin/res/images/thumb_up_32px.png" />										
							</a>							
						</div>
						<div class="po-num" id="supportNumber<s:property value='rootArticle.id'/>"
											flag="true">
								<s:property value='rootArticle.supportNumber'/>
						</div>
					</div>
				</li>
			</ul>
				...
				<ul class="discountList">
					...
					<!-- 贴子区 -->
					 <li>
	        			...
	        			<div style="clear:both;"></div>
	        			<a class="re2so" href="weixin/articleandreplyArticleList?rootArticle.parentArticle.id=<s:property value='id'/>">回复</a>
	        		</li>
		        	<!-- 贴子区 -->
		        	</s:iterator>
				</ul>
	...
	$(function(){
		...
		$(".supportBtn").click(function(){
			...
			$.post("weixin/articleandsupprortArticle",param,function(data){
			   		var arr=new Array();
