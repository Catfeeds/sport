    ...
    window.onerror = myerror;
		...
		<div class="unloadProductWrap">
			<div class="uploadFormWrap">
				<form action="coachProductandupdateCoachProduct" method="post">
				...
				<div class="uploadItem">
					...
					<div calss="itemContent">
						<input type="text"  name="product.employNumber"  value="<s:property value='product.employNumber'/>" class="inputText textLength1"></input>
					</div>
				</div>
				<div class="uploadItem">
					<div class="itemIitle">
					...
					<div calss="itemContent">
						<input type="text" name="product.normalPrice"  value="<s:property value='product.normalPrice'/>" class="inputText textLength1"></input>(每小时)
					</div>
					<div class="itemIitle">
					促销价(&nbsp;&yen;&nbsp;)：
					</div>
					<div calss="itemContent">
						<input type="text" name="product.bargainPrice" value="<s:property value='product.bargainPrice'/>"  class="inputText textLength1"></input>(每小时)
					</div>
				</div>
