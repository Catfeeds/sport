...
<s:url var="searchUrl" value="weixin/weixinandchoosePlace?condition.searchType=place" includeParams="none">
        ...
        <div id="content">
            ...
            <div>
                <ul class="productList">
                    ...
                    <li>
                        <a href="weixin/weixinandchooseDayPlace?placeProduct.id=<s:property value='id'/>&site.id=<s:property value='site.id'/>">
                            <img src=".<s:property value='currentImage.pathName'/>" />
                            <p class="productTitle"><s:property value='site.siteName'/>&nbsp;(<s:property value='productName'/>)</p>
                            <p class="productTitle">地点：<s:property value='site.siteAddress'/></p>
                            <p class="productPrice">¥<s:property value='normalPrice'/></p>
