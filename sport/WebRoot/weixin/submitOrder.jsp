	...
	<div id="content">
	    ...
	    <div class="confirmOrder"> 
	    	<div class="confirmBtn">
	    		<a id="submitBtn" href="javascript:void(0);" url="weixin/orderandtoPayOrder?order.id=<s:property value='order.id'/>">确认订单</a>
	    	</div>	
	    </div>
	    <div class="clear"></div>
	    <div class="warnInfo">
    ...
    var sends = {
    	...
    	send:function(){
    			...
    			if(val!=""&&(val.length==11)){
    				$.post("commonandsendMessage", { "code.phone":val,"code.templateId":"2"},
    				   function(data){
    				   		 var arr=new Array();
