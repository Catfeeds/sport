$(function(){
	...
	$(".kapkey").focus(function(){
		...
		{
			$("#mz_Float").css("top","412px");
		}
		else
		{
			$("#mz_Float").css("top","382px");
		}
	...
	$(".password,.password1").focus(function(){
		...
		{
			$("#mz_Float").css("top","506px");
		}
		else if($(".error1").css("display")=="block" || $(".error2").css("display")=="block")
		{
			$("#mz_Float").css("top","476px");
		}
		else
		{
			$("#mz_Float").css("top","446px");
		}
		
		$("#mz_Float").find(".bRadius2").html("此项为登录密码，长度为8-16个字符，区分大小写，至少包含两种类型");
	});
	...
	$(".username").focus(function(){
		...
		$("#mz_Float").find(".bRadius2").html("此项为用户名，可用于登录，长度为4-32个字符支持数字、字母、下划线，字母开头，字母或数字结尾");
	});
	//邮箱栏获得焦点
