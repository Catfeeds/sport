        ...
        <div class="tabContent  selectedContent">
		  ...
		  <div class="innerContent">
			  ...
			  <dl>
				...
				<dd>
					<div id="realName">
						<div class="alterContent" id="currentRealName">${user.realName }</div>
						<div class="alterBtn">
			 ...
			 <dl>
				...
				<dd>
					<div id="sex">
						<div class="alterContent" id="currentSex">${user.sex }</div>
						<div class="alterBtn">
        ...
        <div class="tabContent">
         ...
         <div class="innerContent">
			  <dl>
				...
				<dd>
					<div id="phone">
						<div class="alterContent"  id="currentPhone">${user.phone }</div>
						<div class="alterBtn">
			  ...
			  <dl>
				...
				<dd>
					<div id="telphone">
						<div class="alterContent"  id="currentTelephone">${user.telephone }</div>
						<div class="alterBtn">
			  ...
			  <dl>
				...
				<dd>
					<div id="email">
						<div class="alterContent" id="currentEmail">${user.email }</div>
						<div class="alterBtn">
			  ...
			  <dl>
				...
				<dd>
					<div id="postcode">
						<div class="alterContent" id="currentPostcode">${user.postcode }</div>
						<div class="alterBtn">
        ...
        <div class="tabContent">
          <h3>用户等级信息</h3>
           <div class="innerContentPosition">
			  <dl>
				<dt><span class="high">等级：</span></dt>
				<dd>
					<div id="level">
						<div class="alterContent">${user.level}</div>
						<div class="alterBtn">
							不可编辑
						</div>
					</div>
			  ...
			  <dl>
				<dt><span class="high">积分：</span></dt>
				<dd>
					<div id="integration">
						<div class="alterContent">${user.integration }</div>
						<div class="alterBtn">
						不可编辑
						</div>
					</div>				
			   ...
			   <dl>
				<dt><span class="high">注册日期：</span></dt>
				<dd>
					<div id="registerDate">
						<div class="alterContent">${user.registerDate }</div>
						<div class="alterBtn">
						不可编辑
						</div>
					</div>			
        ...
        <div class="tabContent">
         <h3>个人简介：</h3>
          <dl>
				...
				<dd>
					<div id="detail">
						<div class="alterContent"  id="currentDetail">${user.detail }</div>
						<div class="alterBtn">
...
<script type="text/javascript">
	$(function(){
		...
		//后台处理的路径
		var operateUrl="userandalterUserInfo";
		//密码
